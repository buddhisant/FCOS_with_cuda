...
class BottleNeck(torch.nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = torch.nn.Conv2d(inplanes, planes, kernel_size=1, stride=stride, bias=False)
        self.bn1 = utils.FrozenBatchNorm2d(planes)
        ...
        self.bn3 = utils.FrozenBatchNorm2d(planes*self.expansion)
...
def build_layer(block, input_channels, planes, num_blocks, stride=2):
    ...
    if stride!=1 or input_channels != planes*block.expansion:
        downsample = torch.nn.Sequential(
            ...
            utils.FrozenBatchNorm2d(planes * block.expansion)
        )
...
class resNet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.bn1=utils.FrozenBatchNorm2d(self.inplanes)
        self.relu=torch.nn.ReLU(inplace=True)
    ...
    def load_pretrained(self, pretrained_path="./pretrained/resnet50_caffe.pth"):
