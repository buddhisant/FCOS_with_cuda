...
class COCODataset(Dataset):
    ...
    def __getitem__(self, idx):
        if(self.is_train):
            ...
            img, gt_bboxes, gt_labels = self.transforms(img, gt_bboxes, gt_labels)

            return {"images": img, "bboxes": gt_bboxes, "labels": gt_labels}
            ...
            return {"images": img, "ori_img_shape": ori_img_shape, "indexs": idx}
